...
export const heroMetricsData: HeroMetric[] = [
  {
    value: '10,000+',
    label: 'Active Jobs',
    iconName: 'Briefcase'
...
export const popularSearchesData: string[] = [
  'React Developer',
  'Product Designer',
  'Data Scientist',
  'DevOps'
...
export const benfitPointsData: string[] = [
...
export const careerMilestonesData: CareerMilestone[] = [
